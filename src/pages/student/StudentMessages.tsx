...
export default function StudentMessages() {
  ...
  const fetchData = async () => {
    try {
      ...
      if ((inboxRes as any).success) {
        setInbox((inboxRes as any).messages);
        setUnreadCount((inboxRes as any).unreadCount);
      }
      if ((sentRes as any).success) setSentMessages((sentRes as any).messages);
      if ((conversationsRes as any).success) setConversations((conversationsRes as any).conversations);
      if ((usersRes as any).success) setMessageableUsers((usersRes as any).users);
    } catch (error: any) {
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Communicate with your instructors and advisors
              </p>
            </div>
